...
///Fonction pour lancer : nouvelle promise de la classe ObjectService
//constante pour appeler la fonction qui fait le fetch et appel de celle qui fait le rendu html dynamique
(async function () {
...
function displayObjects(objects) {
  objects.forEach((object) => {
    const objectsContainer = document.getElementById("products");
    objectsContainer.innerHTML += `<article id="productContainer" class="product__container">
